...
BankAccount::BankAccount(string bin, string accNum, int checkDigit, string pin, double balance) : BIN(bin), accountNumber(accNum), checkDigit(checkDigit), PIN(pin), balance(balance)
{
}
